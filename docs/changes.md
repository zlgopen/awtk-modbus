2026/8/3
  ...
  * 为 modbus_memory_default 添加钩子函数
...
2026/5/11
  * 修复了在RTU模式下，从站无法处理0x17功能码的问题(感谢雪飞提供补丁)

2026/5/09
  * 修复了使用串口从站时，客户端使用错误的从站地址会导致从站完全断开，且从站无法再被连接的问题(感谢雪飞提供补丁)
  * 完善了自动重连(感谢雪飞提供补丁)
...
2026/4/15
  * 完善了awtk-modbus的字节序处理(感谢雪飞提供补丁)
  * 完善了 api 注释(感谢雪飞提供补丁)

2026/02/26
  * 增加tcp_set_keep_info功能
